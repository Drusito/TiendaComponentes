...
public class Tienda {
    ...
    private void initComponentes(){
        DiscoDuro disco1 = new DiscoDuro(87.10f, "Es un solución para el almacenamiento sustancial que ofrece velocidades de lectura/escritura1 de hasta 2.100/1.700 MB/s, que entre triplica y cuadriplica la de los discos SSD basados en SATA", "Kingston", 1000, true, "SSD", 1700);
        DiscoDuro disco2 = new DiscoDuro(35.90f, "Versátiles. Rápidos. Fiables. La unidad de disco duro más increíble que haya conocido.", "Seagate", 500, true, "Sata", 275);

        MemoriaGrafica memoria1 = new MemoriaGrafica(2199.94f, "Ofrecen el máximo rendimiento para jugadores y creadores. Con tecnología de Ampere, la arquitectura RTX de la segunda generación de NVIDIA, con nuevos núcleos RT y Tensor y multiprocesadores de streaming para los gráficos de trazado de rayos más realistas y las funciones de inteligencia artificial más innovadoras.", "Nvidia", 12);
        MemoriaGrafica memoria2 = new MemoriaGrafica(1348.73f, "Diseñada para brindar un rendimiento ultra alto, una resolución ultra alta y juegos visualmente impresionantes para todos. Estamos impulsando la próxima generación de juegos.", "AMD", 12);

        PlacaBase placa1 = new PlacaBase(449.43f, "Ofrece suministro de energía y enfriamiento de primera calidad para liberar toda la fuerza de los procesadores Intel® Core ™ de 12.ª generación.", "Asus", 4, 4, 2, true, 2,1, true, true);
        PlacaBase placa2 = new PlacaBase(561.23f, "Ofrece ofrece controles exhaustivos de iluminación RGB, así como efectos para los LED integrados y las tiras LED que conectes a los conectores RGB de la placa.", "Asus", 2, 2, 2, true, 2,1, true, true);

        Procesador cpu1 = new Procesador(669.89f, "Un procesador que permite jugar así como crear.", "AMD", 16, 3.4f);
        Procesador cpu2 = new Procesador(299.90f, "Ofrece mejoras de rendimiento notables para conseguir una productividad mejorada y un entretenimiento impresionante", "Intel", 16, 5.1f);

        RAM ram1 = new RAM(37.30f, "Ofrece un potente aumento de rendimiento para juegos, edición de vídeo y renderización con velocidades de hasta 3733 MHz", "Kingston", 8);
        RAM ram2 = new RAM(76.15f, "El disipador de calor, fabricado en aluminio puro, permite una disipación térmica más rápida; la placa impresa de ocho capas administra el calor y proporciona una capacidad superior para incrementar el overclocking.", "Corsair", 16);
    ...
    private void initPerifericos(){
        ...
        Teclado teclado1 = new Teclado(19.99f, "Cuenta con fiable conexión inalámbrica hasta a 10 metros de distancia, que comparten un minúsculo receptor USB. Sin líos de emparejamiento ni de instalación de software.", "Logitech", true, true, true);
        Teclado teclado2 = new Teclado(29.98f, "Puedes personalizar con millones de colores y hasta 10 efectos de luz pre-definidos en 6 zonas.", "MSI", false, true, true);
